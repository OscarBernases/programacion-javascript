• Crea una aplicación web que pida, en sendos cuadros de lectura de datos: el nombre, los apellidos, el salario (número con decimales) y la edad de una persona (un número)
...
lo que indican los puntos siguientes).
